...
- `nx g @simondotm/nx-firebase:function my-function --firebaseApp server-app` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

- `nx run server-app:deploy` - Deploy this app to firebase
- `nx run server-app:serve` - Serve this app using the firebase emulator
- `nx run server-app:build` - Build all functions associated with this app
- `nx run server-app:test` - Test all functions associated with this app
- `nx run server-app:lint` - Lint all functions associated with this app
